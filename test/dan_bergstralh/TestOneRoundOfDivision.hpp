...
class TestOneRoundOfDivision : public AbstractCellBasedWithTimingsTestSuite
{
public:
    ...
    void TestSimulation() throw (Exception)
    {
        ...
        double simulation_duration = 250.0;
        ...
        out << "TestOneRoundOfDivisionOffTissueAxis";
        ...
        simulation.SetSamplingTimestepMultiple(6.0/time_step);
        ...
        p_stretch_modifier->SetSpeed(0.03);
