...
#ifndef LINEARGROWTHTARGETAREAMODIFIER_HPP_
#define LINEARGROWTHTARGETAREAMODIFIER_HPP_
...
class LinearGrowthTargetAreaModifier : public AbstractTargetAreaModifier<DIM>
{
private:
...
public:
     ...
     * Default constructor.
     */
    LinearGrowthTargetAreaModifier();

    /**
     * Destructor.
     */
    virtual ~LinearGrowthTargetAreaModifier();
...
#endif /*LINEARGROWTHTARGETAREAMODIFIER_HPP_*/
