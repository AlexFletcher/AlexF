#ifndef CELLSTRIPESWRITER_HPP_
#define CELLSTRIPESWRITER_HPP_
...
class CellStripesWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
public:
     ...
     *
     * Visit a cell and write its stripe identity.
     *
